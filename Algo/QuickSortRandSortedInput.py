...
class QuickSortRand:
    ...
    def __partition(input_list, low, high):
        ...
        input_list[high] = input_list[p_rand]
        input_list[p_rand] = temp
    ...
    def __quick_sort(input_list, low, high):
        if low < high:
            partition = QuickSortRand.__partition(input_list, low, high)
            QuickSortRand.__quick_sort(input_list, low, partition - 1)
            QuickSortRand.__quick_sort(input_list, partition + 1, high)
    ...
    def sort(input_list):
        ...
        QuickSortRand.__quick_sort(input_list, 0, len(input_list) - 1)
        return input_list, time.clock() - start_time
...
if __name__ == '__main__':
    ...
    result = QuickSortRand.sort(input_list)
